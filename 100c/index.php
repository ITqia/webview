...
<head>
    ...
    <meta name="game-id" content="jxybc" />
    ...
    <style>
        ...
        #gameDiv{
            display:inline-block;width:100%; height:100%;margin: 0 auto; background: black; position:relative;
        }
        #log{
            position:fixed;
            bottom:0px;
...
var __extends = this.__extends || function(d, c) {
	...
	GameApp = function(d) {
		...
		c.prototype.gameOver = function() {
            ...
            // wx.miniProgram.redirectTo({ url: '../logs/logs'});
		};
		...
		c.prototype.onShare =function(b) {
                ...
                // logc(JSON.stringify(wx.miniProgram));     
